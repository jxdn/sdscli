...
def main():
    ...
    parser_ci_add_job.add_argument('storage', choices=['s3', 's3s', 'gs', 'dav', 'davs', 'az'],
    ...
    parser_pkg_export.add_argument('--accounts', '-a', action='store_true', help="save allowed accounts")
